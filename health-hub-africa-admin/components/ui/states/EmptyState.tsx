    ...
    return (
      ...
      >
        <div className="flex items-center gap-3 text-left">
          <div className="w-10 h-10 rounded-xl bg-[var(--color-primary-light,#EBF5EC)] flex items-center justify-center shrink-0">
            <Icon className="w-5 h-5 text-[var(--color-primary,#137333)]" />
          </div>
          <div>
    ...
    >
      <div className="relative mb-4">
        <motion.div
          ...
          className="w-16 h-16 rounded-2xl bg-[var(--color-primary-light,#EBF5EC)] flex items-center justify-center text-[var(--color-primary,#137333)] shadow-inner"
        >
          <Icon className="w-8 h-8" />
        </motion.div>

        {badgeText && (
          <span className="absolute -top-2 -right-2 px-2.5 py-0.5 text-[10px] font-bold rounded-full bg-amber-500 text-white shadow-sm">
            {badgeText}
          </span>
        )}
      </div>
