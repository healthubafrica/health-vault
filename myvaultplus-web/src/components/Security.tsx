...
const items = [
  {
    ...
    desc: 'Records are never stored or cached locally — delivered only to your authenticated session on protected servers.',
  ...
  },
  {
    ...
    desc: 'Every request encrypted end-to-end. HTTPS/TLS on all connections — no exceptions, no gaps.',
