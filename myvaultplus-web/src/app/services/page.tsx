  ...
  return (
    <div style={{ width: '100%', overflowX: 'hidden', background: '#F1F4EF' }}>
        ...
        <section style={{ position: 'relative', background: '#041E14', overflow: 'hidden', minHeight: '88vh', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div className="hero-content">
            <h1 style={{ margin: '0 0 18px', lineHeight: 1.06, fontFamily: 'var(--font-manrope), sans-serif' }}>
              ...
              <span style={{ display: 'block', fontFamily: 'var(--font-manrope), sans-serif', fontStyle: 'italic', fontWeight: 700, fontSize: 'clamp(32px, 5.5vw, 58px)', color: '#6DC43F', letterSpacing: '-0.02em', lineHeight: 1.06 }}>One Platform.</span>
            </h1>
      ...
      <div className="page-card" style={{ background: '#F7FAF7' }}>
        <section className="section-inner">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#137333', marginBottom: 18 }}>— Services</div>
            <h2 style={{ fontFamily: 'var(--font-manrope), sans-serif', fontWeight: 600, fontSize: 'clamp(28px, 3.5vw, 40px)', lineHeight: 1.1, letterSpacing: '-0.02em', margin: '0 auto 16px', maxWidth: 640 }}>
              ...
              <em style={{ fontFamily: 'var(--font-manrope), sans-serif', fontStyle: 'italic', fontWeight: 700 }}>intelligent access.</em>
            </h2>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr 1fr', gap: 16 }}>
            ...
            <div style={{ background: '#07251C', borderRadius: 22, overflow: 'hidden', display: 'flex', flexDirection: 'column', padding: 16, gap: 16 }}>
              ...
              <div style={{ padding: '8px 8px 12px' }}>
                <span style={{ display: 'inline-flex', alignItems: 'center', background: 'rgba(109,196,63,0.18)', color: '#6DC43F', fontSize: 11, fontWeight: 700, padding: '5px 12px', borderRadius: 100, letterSpacing: '0.04em', marginBottom: 10 }}>TeleCare™</span>
            ...
            <div style={{ background: '#fff', border: '1px solid rgba(7,37,28,0.09)', borderRadius: 22, padding: 28, display: 'flex', flexDirection: 'column', gap: 18 }}>
              <div>
                <span style={{ width: 44, height: 44, borderRadius: 12, background: '#EAF7F1', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <svg width="21" height="21" viewBox="0 0 24 24" fill="none"><path d="M9 11l2 2 4-4" stroke="#137333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><path d="M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6l7-3z" stroke="#137333" strokeWidth="2" strokeLinejoin="round" /></svg>
                </span>
              ...
              <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                {['18+ specialist fields', 'Full document upload', 'PDF report to your Vault'].map((b) => (
                  <div key={b} style={{ display: 'flex', gap: 8, fontSize: 13, color: '#27433A' }}><span style={{ color: '#137333', fontWeight: 700 }}>✓</span>{b}</div>
                ))}
                <Link href="/expert-review" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, color: '#137333', fontWeight: 600, fontSize: 13.5, textDecoration: 'none', marginTop: 4 }}>
                  Learn more →
                </Link>
              </div>
            </div>
            ...
            <div style={{ background: '#fff', border: '1px solid rgba(7,37,28,0.09)', borderRadius: 22, padding: 28, display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                <Link href="/dispatchcare" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, color: '#137333', fontWeight: 600, fontSize: 13.5, textDecoration: 'none', marginTop: 4 }}>
                  Learn more →
                </Link>
              </div>
            </div>
          ...
          {/* Row 2 */}
          <AnimatedSection stagger className="rg-3" style={{ marginTop: 16 }}>
        ...
        <section className="section-inner">
          <div className="rg-2">
            <div style={{ background: '#0C3328', borderRadius: 22, padding: 36 }}>
              <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#6DC43F', marginBottom: 16 }}>Expert Review™</div>
              ...
              <Link href="/expert-review" style={{ color: '#6DC43F', fontWeight: 600, fontSize: 14, textDecoration: 'none' }}>Learn about Expert Review™ →</Link>
            </div>
      ...
      <div className="page-card" style={{ background: '#fff' }}>
        <section className="section-inner">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#137333', marginBottom: 18 }}>— NeuroFlex™</div>
            <h2 style={{ fontFamily: 'var(--font-manrope), sans-serif', fontWeight: 600, fontSize: 'clamp(28px, 3.5vw, 40px)', lineHeight: 1.1, letterSpacing: '-0.02em', margin: '0 auto 16px', maxWidth: 640 }}>
              Specialist neurology,{' '}
              <em style={{ fontFamily: 'var(--font-manrope), sans-serif', fontStyle: 'italic', fontWeight: 700 }}>within reach.</em>
            </h2>
          </div>
