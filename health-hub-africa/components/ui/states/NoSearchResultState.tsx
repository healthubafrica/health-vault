...
export function NoSearchResultState({
  ...
  suggestions = ['Vitals', 'Prescriptions', 'General Telecare', 'Lab Results', 'Doctors'],
  onSelectSuggestion,
  onClearSearch,
  onResetFilters,
  className = '',
  ...
  return (
    ...
    >
      <div className="w-16 h-16 rounded-2xl bg-[var(--color-primary-light)] flex items-center justify-center text-[var(--color-primary)] mb-4 shadow-inner">
      ...
      <p className="text-xs text-[var(--color-text-muted)] max-w-xs mb-4 leading-relaxed">
        ...
        <span className="font-semibold text-[var(--color-text)] bg-[var(--color-bg)] px-2 py-0.5 rounded-md border border-[var(--color-border)]">
          "{searchTerm}"
        </span>
      </p>
      ...
      {suggestions.length > 0 && (
        <div className="w-full mb-6">
          <p className="text-[11px] font-bold text-[var(--color-text-faint)] uppercase tracking-wider mb-2.5">
          ...
          <div className="flex flex-wrap items-center justify-center gap-1.5">
            {suggestions.map((suggestion) => (
              <button
                ...
                className="text-[11px] font-medium px-2.5 py-1 rounded-full bg-[var(--color-bg)] text-[var(--color-text-muted)] border border-[var(--color-border)] hover:border-[var(--color-primary)] hover:text-[var(--color-primary)] transition-all cursor-pointer flex items-center gap-1"
              >
